# Sphinx configuration for the PopulationSim documentation.
# This file is maintained in-repo and reads project metadata from pyproject.toml.
...
except ImportError:  # pragma: no cover - depends on the local docs environment
